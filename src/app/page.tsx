...
// Type assertion for guestList
const typedGuestList = guestList as GuestList;

// import { sendDiscordMsg } from "../utils/discord";

function mapGuestData(guestName: string) {
  if (typedGuestList.hasOwnProperty(guestName)) {
    return typedGuestList[guestName];
  }
  return false;
}
...
export default function Home() {
  ...
  const guestData = mapGuestData(guestName);
